...
namespace KiaKooshar.Application.Features.Identities.Users.Handlers.Queries.GetUserById
{
        ...
        IRequestHandler<GetUserByIdQuery, ResultDTO<GetUserByIdDTO>>
    {
            ...
            )
        {
            ...
            if ( user is null )
                return ResultDTO<GetUserByIdDTO>.NotFound
                    ("User doesnt found");
            var mappedUser = _mapper.Map<GetUserByIdDTO> (user);
            return ResultDTO<GetUserByIdDTO>.Success (
                mappedUser,
                ""
                );
        }
